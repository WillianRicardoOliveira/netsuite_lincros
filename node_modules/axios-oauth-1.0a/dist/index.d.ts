...
interface OAuthInterceptorConfig {
    /**
...
declare const addOAuthInterceptor: (client: AxiosInstance, { algorithm, includeBodyHash, key, realm, secret, token, tokenSecret, callback, verifier, }: OAuthInterceptorConfig) => number;

export { type OAuthInterceptorConfig, addOAuthInterceptor as default };
